    ...
    public void SystemObject() {
        ...
        while (true) {
            ...
            while (enemyHealth > 0) { //Greater than 0 -> keeps looping
                ...
                switch (input) {
                    case "1":  //if user types 1. this block activates the attack mode.
                        ...
                        break;
                    case "2":  //if user types 2. this block activates the potion mode.
